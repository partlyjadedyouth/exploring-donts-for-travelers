...
import { buildFilterTags, insightMatches } from "@/lib/insights-utils";
...
export default function InsightPanel({ filters }: Props) {
  ...
  return (
    <aside className="flex h-full min-h-65 flex-col gap-4 ring-1 ring-neutral-100 backdrop-blur">
